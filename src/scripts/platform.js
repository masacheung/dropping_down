...
export default class Platform {
    ...
    drawBackground(ctx) {
        ...
        if (this.running){
            ...
            ctx.fillText("Click To Pause.", this.dimensions.width/2, this.dimensions.height - 325);
            ctx.fillText("'Everytime Pause the Game, the charater will move faster!!!'", this.dimensions.width/2, this.dimensions.height - 300);
